...
<template>
    <div>
        <h4 class="ju" v-if="!id">新增宣传素材分类</h4>
        <h4 class="ju" v-else>编辑宣传素材分类</h4>
        <br>
        ...
        <div class="width70 flex-end">
            <Button class="blueBtn" @click="okAdd" v-if="!id">确认新增宣传素材分类</Button>
...
export default {
    data () {
        return {
            ...
            id: "",
            rules: {
                name: [ { required: true, message: "请输入宣传素材分类名称",trigger: 'blur' } ],
            },
        }
    },
    created () {
