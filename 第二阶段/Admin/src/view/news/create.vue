...
<template>
    <div>
                ...
                <div class="flex3">
                    <FormItem label="" prop="news_category_id">
                        <div class="al">
                            ...
                            <select class="input" v-model="addForm.news_category_id">
        ...
        <div class="width70 flex-end">
            <Button class="blueBtn" @click="okAdd" v-if="!id">确认新增新闻</Button>
        ...
        getOne () {
            this.$axios({
                ...
                if (res.data.data[0]) {
                    ...
                    this.addForm.news_category_id = res.data.data[0].news_category_id
                ...
                if (flag) {
                    that.$axios({
                        ...
                        data: {
                            ...
                            news_category_id: this.addForm.news_category_id,
