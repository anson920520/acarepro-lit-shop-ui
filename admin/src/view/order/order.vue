        ...
        <div class="orderBox">
            <div class="clearBoth">
                <div v-for="(item,i) in dataList" :key="i" class="orders relative">
                    <Icon type="md-create" color="000" size="20" class="editIcon" @click="toEdit(item)" />
                    ...
                    <div class="btnGropu ju" @click.stop=''>
        ...
        getData () {
            ...
            this.$axios({
                ...
                if (res.data) {
                    ...
                    this.dataList = res.data.reverse().filter(item => item.status != 1)
                }
            }).catch(e => {
                console.log(e)
                load()
